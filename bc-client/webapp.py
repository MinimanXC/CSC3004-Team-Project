...
def update_delivery():
    ...
    if curr_email:
        ...
        set_home_landing_page()
        return render_template('delivery.html', home_page=home_page, data=order_details)
...
def customer_orders():
    if curr_email:
        ...
        set_home_landing_page()
        return render_template('customer_orders.html', home_page=home_page, data=order_details)
...
def seller_orders():
    ...
    if curr_email:
        ...
        set_home_landing_page()
        return render_template('seller_orders.html', home_page=home_page, data=order_details)
